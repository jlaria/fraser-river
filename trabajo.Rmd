...
Respondiendo a la motivación inicial, la probabildad estimada de que el río desborde superando los 10000 $m^3/s$ en un mes es de $0.0053$. No obstante, usando el enfoque considerado se puede ser más específico en la respuesta. Por ejemplo, la probabilidad de que el río desborde en el mes de Junio es de $0.0464$.
